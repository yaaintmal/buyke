...
const service = __importStar(require("../../src/services/itemsService"));
const ShoppingItem_1 = __importDefault(require("../../src/models/ShoppingItem"));
jest.mock('../../src/models/ShoppingItem', () => ({
    find: jest.fn(),
    deleteMany: jest.fn(),
}));
const MockedShoppingItem = ShoppingItem_1.default;
describe('itemsService', () => {
    beforeEach(() => {
        jest.resetAllMocks();
    });
    it('getAll returns items', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('deleteAll calls deleteMany', () => __awaiter(void 0, void 0, void 0, function* () {
        MockedShoppingItem.deleteMany.mockResolvedValue({ deletedCount: 2 });
        yield service.deleteAll();
